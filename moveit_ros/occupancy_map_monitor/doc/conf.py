...
latex_documents = [
    (master_doc, 'moveit_occupancy_map_monitor.tex', 'moveit\\_occupancy\\_map\\_monitor Documentation',
     'peter', 'manual'),
]
...
man_pages = [
    (master_doc, 'moveit_occupancy_map_monitor', 'moveit_occupancy_map_monitor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'moveit_occupancy_map_monitor', 'moveit_occupancy_map_monitor Documentation',
     author, 'moveit_occupancy_map_monitor', 'One line description of project.',
     'Miscellaneous'),
]
